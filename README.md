...
intervenes is unambiguous divergence (non-finite or exploded loss) and gradient explosion, both
verified. The structural signals are still collected, charted and reported when they trip — they
are informative to a human reading a run — they just no longer get to steer it.
